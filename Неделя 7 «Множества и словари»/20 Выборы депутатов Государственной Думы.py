...
Примеры:
Тест 1
input: Party One 100000
input: Party Two 200000
input: Party Three 400000
output: Party One 64
output: Party Two 129
output: Party Three 257

Тест 2
input: Party number one 100
input: Partytwo 100
output: Party number one 225
output: Partytwo 225

Тест 3
input: Party number one 449
input: Partytwo 1
output: Party number one 449
output: Partytwo 1
"""
